...
#import "YWTestViewController3.h"
#import <YWRouter/YWRouter.h>
#import "YWExcelView.h"


@interface YWTestViewController3 ()
...
@implementation YWTestViewController3
...
- (void)test1{
    ...
    YWExcelView *exceView = [[YWExcelView alloc] initWithFrame:CGRectMake(20, 74, CGRectGetWidth(self.view.frame) - 40, 250) style:YWExcelViewStyleheadPlain headViewText:@[@"类目",@"语文",@"数学",@"物理",@"化学",@"生物",@"英语",@"政治"] height:40];
...
- (void)dealloc{
    NSLog(@"YWTestViewController3--%s",__func__);
}
@end
